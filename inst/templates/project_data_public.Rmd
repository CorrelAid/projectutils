...
get_description_section <- function(section) {
    de <- read_lines(glue::glue("de/{section}.md"))
    en <- read_lines(glue::glue("de/{section}.md"))
    list(en = en, de = de)
}

desc <- Description$new(PROJECT_ID)
desc$title <- get_description_section("title")
desc$summary <- get_description_section("summary")
desc$problem <- get_description_section("problem")
desc$data <- get_description_section("data")
desc$approach <- get_description_section("approach")
desc$impact <- get_description_section("impact")
