...
if (a$past_applications == 'first_application') {
  cat('The applicant is applying to a CorrelAid project for the **first time**.')
    ...
    glue::glue('The applicant was **not successful** with their application(s) so far. They specified the following when asked about when/where they have applied in the past:<br><br> > foo')
}
```

```{r results='asis'}
if (a$past_applications == 'not_successful') {
  cat(glue::glue("**Details: {a$past_applications_details}**"))
}
```
